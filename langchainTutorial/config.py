...
INDEX_PATH_T1 = os.path.join(DATA_DIR, "/home/philibra/langchainTutorial/writingtask1ragdataset/faiss_index") # Path ke folder index T1
INDEX_PATH_T2 = os.path.join(DATA_DIR, "/home/philibra/langchainTutorial/writingtask2ragdataset/faiss_index") # Path ke folder index T2
