...
* **[Klasifikasi Gender Sidik Jari [(Skripsi S1)](link-ke-repo-skripsi-jika-ada)](https://github.com/philibraspacex/williamhong.github.io/tree/main/Skripsi)**: Penelitian dan implementasi model *Convolutional Neural Network* (CNN) dengan arsitektur Inception-ResNetV2 untuk mengklasifikasikan gender berdasarkan citra sidik jari, menggunakan dataset SOCOFing dan NIST SD4. [[**Baca Skripsi**](link-ke-pdf-skripsi-jika-ada)]
* **Penasihat Akademik AI ([Proyek Ini](https://github.com/philibraspacex/williamhong.github.io/tree/main/project2-llmrekomendasi)):** Aplikasi web AI untuk menganalisis transkrip akademik dan memberikan rekomendasi mata kuliah semester depan secara personal. Menggunakan arsitektur RAG canggih dengan *Full Context*, *Prompt Engineering*, *Knowledge Base* korelasi, FAISS, Streamlit, dan Large Language Model yaitu Groq. [[**Demo**](https://williamhongappio-gzpkg4hrzkyd7fy8uuhdmj.streamlit.app/)]
